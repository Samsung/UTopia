...
#endif
extern e1 autofuzz4;
extern enum _e1 autofuzz5;
extern int * autofuzz6;
extern unsigned autofuzz6size;
extern int autofuzz8;
#ifdef __cplusplus
}
#endif
#include "../lib/lib.h"
...
void utc_defined_type_p(){
  ...
  e1 var2 = autofuzz4;
  inputEnum(autofuzz5, var2);

  int Buf[MAX]; { for (unsigned i=0; i<autofuzz6size; ++i) { Buf[i] = autofuzz6[i]; } }
